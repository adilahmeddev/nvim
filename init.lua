...
vim.keymap.set('n', '<leader>ff', ':Neotree float reveal_force_cwd<cr>', { desc = 'Move focus to the upper window' })
-- [[ Basic Autocommands ]]
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      require('session_manager').setup { autoload_mode = config.AutoloadMode.GitSession, config.AutoloadMode.CurrentDir }
    end,
  },
            ...
            Lua = {
              ...
              workspace = {
                library = {
                  ...
                  'C:/Users/adil/AppData/Local/nvim-data/lazy/*/library',
                },
              },
              completion = {
                callSnippet = 'Replace',
